...
def main():
    ...
    # -------------------------------------------------------------------------
    teleop, arm, control, drive = get_shared_frames(frame,sender)
    ...
    # Grid the frames.
    # -------------------------------------------------------------------------
    grid_frames(teleop,arm,control, drive)
...
def get_shared_frames(main_frame, mqtt_sender):
    ...
    drive = shared_gui.get_drive_system_frame(main_frame,mqtt_sender)
    return teleop, arm, control, drive
